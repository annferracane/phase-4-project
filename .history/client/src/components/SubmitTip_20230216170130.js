...
import FormControlLabel from '@mui/material/FormControlLabelf';
            ...
            <ThemeProvider theme={theme}>
                <Container component="main" maxWidth="xs">
                    ...
                    <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
                        ...
                        <Grid item xs={12}>
                        <FormControlLabel
                            control={<Checkbox value={ on_or_off_campus } color="primary" />}
                            label="On campus? Uncheck if this is an off-campus tip."
                        />
                        </Grid>
                        <Grid item xs={12}>
