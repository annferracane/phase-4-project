...
const genderArray = genders.map(gender => <MenuItem value={gender}>{gender}</MenuItem>)
  ...
  return (
    <ThemeProvider theme={theme}>
      <Container component="main" maxWidth="xs">
        ...
        >
          {user.profile ? <Avatar alt={user.profile.full_name} src={user.profile.image} sx={{ m: 1 }} /> : }
            ...
            <Grid container spacing={2}>
              ...
              <FormControl fullWidth>
                ...
                <Select
                    ...
                    id="gender"
                    value={ user.profile ? user.profile.gender : null }
                    label="Gender"
