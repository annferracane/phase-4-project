...
- Has multiple client-side routes using React Router. Includes nav bar or other UI element that allows users to navigate between routes. Follow RESTful convention where applicable.
