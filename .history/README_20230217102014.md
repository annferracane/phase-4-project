...
- Uses controller validations to alter back end json response to front end. Passes error messages to the front end and display them if the action fails. HINT: Utilize record.errors.
