...
#     User.find(num).update(
#         user_type: ["Prospective Student", "College Student", "Alum"].sample
#     )
#     num = num + 1
# end

# User.includes(:tips).where.not(tips: {id: nil})
User.where(user_type: "Prospective Student").map { |user| user.tips.destroy_all }