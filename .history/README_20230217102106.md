...
- Implement authentication/authorization, including password protection. User can sign up with a new user account, log in to the site with a secure password and stay logged in via user ID in the session hash, and
log out of the site.
